...
public class MyAspect2 {
    ...
    public void before(JoinPoint jp) {
        ...
        System.out.println(obj.getClass().getName()+"：Aop2,方法名称："+methodName+" 准备执行 开始时间："+new Date());
...
//    }
    ...
    public void after(JoinPoint jp) {
        ...
        System.out.println(obj.getClass().getName()+"：Aop2,方法名称："+methodName+" 结束了 结束时间："+new Date());
        System.out.println(methodName+" Aop2,方法总执行耗时"+(aftertime-beforetime)+"毫秒");
    }
