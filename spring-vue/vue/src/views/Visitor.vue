...
<!--        <el-button type="success" icon="el-icon-top">导出</el-button>-->
        <el-upload
                action="http://localhost:9090/visitor/import"
        ...
        <el-input v-model="search" style="width: 255px;right: 180px;position: absolute;" placeholder="请输入查询访客姓名" clearable></el-input>
    ...
    export default {
        ...
        methods:{
            deleteBatch(){
                ...
                request.post("/api/visitor/deleteBatch",this.ids).then(res=>{
                    if (res.code==='0'){
            ...
            save(){
                if (this.form.id){//判断是否是更新
                    request.put("/api/visitor",this.form).then(res=>{
                        console.log(res)
                    ...
                    request.post("/api/visitor", this.form).then(res => {
                        console.log(res)
                        this.$message({
                            type:"success",
                            message:"新增成功"
            ...
            handleDelete(id){//删除
                console.log(id)
                request.delete("/api/visitor/"+id).then(res=>{
                    if (res.code=='0'){//判断返回结果是否成功
                        this.$message({
                            type:"success",
                            message:"删除成功"
            ...
            exportUser() {
                ...
                location.href = "http://localhost:9090/visitor/export";
            },
        }
    }
</script>
