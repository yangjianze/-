...
<!--        <el-button type="success" icon="el-icon-top">导出</el-button>-->
        <el-upload
                action="http://localhost:9090/classs/import"
        ...
        <el-input v-model="search" style="width: 255px;right: 180px;position: absolute;" placeholder="请输入查询班级编号" clearable></el-input>
        ...
        <div style="margin: 15px 0px">
            ...
            <el-dialog
                ...
                <el-form :model="form" label-width="150px">
                    ...
                    <el-form-item label="辅&nbsp;&nbsp;导&nbsp;&nbsp;员：">
                        <el-input v-model="form.counsellor" style="width: 70%"></el-input>
                    </el-form-item>
                </el-form>
                <template #footer>
    ...
    export default {
        ...
        methods:{
            deleteBatch(){
                ...
                request.post("/api/classs/deleteBatch",this.ids).then(res=>{
                    if (res.code==='0'){
            ...
            save(){
                if (this.form.id){//判断是否是更新
                    request.put("/api/classs",this.form).then(res=>{
                        console.log(res)
                    ...
                    request.post("/api/classs", this.form).then(res => {
                        console.log(res)
                        this.$message({
                            type:"success",
                            message:"新增成功"
            ...
            handleDelete(id){//删除
                console.log(id)
                request.delete("/api/classs/"+id).then(res=>{
                    if (res.code=='0'){//判断返回结果是否成功
                        this.$message({
                            type:"success",
                            message:"删除成功"
            ...
            exportUser() {
                ...
                location.href = "http://localhost:9090/classs/export";
            },
