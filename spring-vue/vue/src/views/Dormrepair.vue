...
<!--        <el-button type="success" icon="el-icon-top">导出</el-button>-->
        <el-upload
                action="http://localhost:9090/dormrepair/import"
        ...
        <el-input v-model="search" style="width: 255px;right: 180px;position: absolute;" placeholder="查询维修人员" clearable></el-input>
            ...
            <el-dialog
                ...
                <el-form :model="form" label-width="150px">
                    ...
                    <el-form-item label="维修项目：">
                        <el-input v-model="form.reason" style="width: 70%"></el-input>
                    </el-form-item>
    ...
    export default {
        ...
        methods:{
            deleteBatch(){
                ...
                request.post("/api/dormrepair/deleteBatch",this.ids).then(res=>{
                    if (res.code==='0'){
            ...
            save(){
                if (this.form.id){//判断是否是更新
                    request.put("/api/dormrepair",this.form).then(res=>{
                        console.log(res)
                    ...
                    request.post("/api/dormrepair", this.form).then(res => {
                        console.log(res)
                        this.$message({
                            type:"success",
                            message:"新增成功"
            ...
            handleDelete(id){//删除
                console.log(id)
                request.delete("/api/dormrepair/"+id).then(res=>{
                    if (res.code=='0'){//判断返回结果是否成功
                        this.$message({
                            type:"success",
                            message:"删除成功"
            ...
            exportUser() {
                ...
                location.href = "http://localhost:9090/dormrepair/export";
            },
        }
    }
</script>
